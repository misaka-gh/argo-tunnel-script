...
Use CloudFlare's Argo Tunnel to achieve intranet penetration!

## 使用方法

```shell
wget -N https://raw.githubusercontents.com/Misaka-blog/argo-tunnel-script/master/argo.sh && bash argo.sh
```
